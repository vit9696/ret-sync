...
cmd_subfolder = os.path.realpath(os.path.abspath(os.path.join(os.path.split(inspect.getfile( inspect.currentframe() ))[0],"sync")))
...
BROKER_PATH = os.path.join(os.path.normpath(os.path.dirname(__file__)), "sync/broker.py")
...
SYNC_ON_ICON = idaapi.load_custom_icon(os.path.join(os.path.dirname(__file__), 'sync/sync_on.png'))
SYNC_OFF_ICON = idaapi.load_custom_icon(os.path.join(os.path.dirname(__file__), 'sync/sync_off.png'))
